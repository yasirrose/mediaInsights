<template>
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item active">PODCAST SERIES</li>
    </ul>

    <h1 class="page-header">
        Podcast Series <small></small>
    </h1>
    <!-- Add Podcast button -->
    ...
    <div class="modal fade" id="modalXl" v-show="showForm">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <form class="" @submit.prevent="handleSubmit" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" id="podcast-description" v-model="podcast.description"
                                rows="3" :class="{ 'is-invalid': errors.description }" required></textarea>
